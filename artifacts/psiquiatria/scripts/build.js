...
async function startMetro(expoPublicDomain, expoPublicReplId) {
  ...
  // Em produção (publish), o Replit troca CLERK_PUBLISHABLE_KEY pelos
  // valores live automaticamente. Forwarda pro Metro pro bundle web
  // pegar a chave live + proxy URL corretos em build time.
  const clerkProxyUrl = `https://${expoPublicDomain}/api/__clerk`;
  const env = {
    ...process.env,
